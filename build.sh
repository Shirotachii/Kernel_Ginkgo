...
LOCAL_DIR="$(pwd)/.."
ZIPNAME="Kurumi-Ginkgo-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
ZIPNAME_KSU="Kurumi-Ginkgo-KSUNext-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
...
export ARCH="arm64"
export KBUILD_BUILD_HOST="Wistoria"
